...
:::note[キャプチャー指示]
このページには、撮影後に `src/assets/captures/manual/d-05-asset-panel-open.png` を入れてください。
撮影対象: D-05「Asset Panelを開いた状態」。Asset一覧、Upload、検索が見える
...
:::note[キャプチャー差し込み位置]
ここには「アセットパネルアイコン」が分かる実画面キャプチャーを入れてください。ページ上部のキャプチャー指示にある保存ファイル名へ差し替えます。
:::
