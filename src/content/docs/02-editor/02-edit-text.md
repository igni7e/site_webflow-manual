...
エディターモードでの更新作業のうち、最も頻度が高いのが「文字の書き換え」です。会社情報、サービス内容、ブログ記事の誤字脱字修正など、様々な場面で必要になります。操作は非常に直感的です。
...
1.  エディターモードを開く:
    「No.9」の手順で、編集したいサイトをエディターモードで開きます。
...
4.  青い枠と鉛筆アイコンを確認:
    ...
    ![テキスト編集の合図](https://uploads-ssl.webflow.com/xxxxxxxx/xxxxxxxx_TextEditIcon.png)  
    *※画像はイメージです。*
...
次のステップ:
文字の書き換えはマスターしましたね。次は、文章にメリハリをつけるための「No.11 エディターで文章の一部を太字にする方法」を学びましょう。
