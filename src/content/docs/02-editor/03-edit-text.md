---
title: "B-3. エディターでサイトの文字を書き換える方法"
description: "クライアント向けWebflow更新マニュアル：エディターでサイトの文字を書き換える方法"
sidebar:
  order: 3
  label: "B-3. エディターでサイトの文字を書き換える方法"
---
...
1.  Webflowを開く:
    [B-2. Content Editor（最新版）でWebflowを開く方法](/02-editor/02-open-content-editor/)の手順で、編集したいサイトをContent editor roleで開きます。
...
最後に必ず「[変更を保存してサイトに反映させる方法](/02-editor/08-save-and-publish/)」の手順に沿って、変更を公開（Publish）してください。

---

次のステップ:
文字の書き換えはマスターしましたね。次は、文章にメリハリをつけるための「[エディターで文章の一部を太字にする方法](/02-editor/04-bold-text/)」を学びましょう。

![テキスト修正の安全手順の図解](../../../assets/ai-diagrams/manual/text-edit-safe-steps.png)

:::note[図解の見方]
文字修正は、編集できる表示を確認し、修正後にデスクトップとスマートフォンの見え方を確認してからPublishします。
:::
