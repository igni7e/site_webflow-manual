...
Webサイトの印象を大きく左右する「画像」。エディターモードを使えば、専門知識がなくても簡単に既存の画像を新しいものに差し替えることができます。
...
1.  **エディターモードでサイトを開く:**
    まずはエディターモードでサイトを開き、画像を差し替えたいページを表示します。
...
3.  **青い枠と画像アイコンを確認:**
    ...
    ![画像編集の合図](https://uploads-ssl.webflow.com/xxxxxxxx/xxxxxxxx_ImageEditIcon.png)  
    *※画像はイメージです。*
...
- **画像サイズ（ファイルサイズ）:**
  ...
  「No.54 「画像がアップロードできません！」原因と対処法」もご参照ください。
...
画像の差し替えが終わったら、忘れずに「No.15」の手順で変更を**公開（Publish）**してください。

---

**次のステップ:**
画像の差し替えができると、サイトの印象をガラッと変えられますね。次は、設定済みのリンク先を変更したい場合の「No.14 エディターでリンク先のURLを変更する方法」です。
