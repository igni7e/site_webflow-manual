...
![リッチテキストフィールド](https://uploads-ssl.webflow.com/xxxxxxxx/xxxxxxxx_RichTextField.png)  
*※画像はイメージです。*
...
![リッチテキストツールバー](https://uploads-ssl.webflow.com/xxxxxxxx/xxxxxxxx_RichTextToolbar.png)  
*※画像はイメージです。*
...
**次のステップ:**
まずは文章の入力が基本です。次は、文章にメリハリをつけるための装飾「No.23 本文の文字を太字にする・斜体にする」を学びましょう。
