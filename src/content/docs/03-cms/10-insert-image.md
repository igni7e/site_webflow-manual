...
:::note[キャプチャー指示]
このページには、撮影後に `src/assets/captures/manual/c-13-insert-image-menu.png` を入れてください。
撮影対象: C-13「本文中に画像を入れるメニュー」。`+` ボタン、Image選択が見える
...
3.  <strong>メディア挿入オプションを表示:</strong>
    ...
    :::note[キャプチャー差し込み位置]
    ここには「メディア挿入メニュー」が分かる実画面キャプチャーを入れてください。ページ上部のキャプチャー指示にある保存ファイル名へ差し替えます。
    :::
