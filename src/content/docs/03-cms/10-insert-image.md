...
-   <strong>ファイルサイズ（容量）:</strong> ページの表示速度とSite usageのBandwidth使用量に影響するため、本文中に多くの画像を挿入する場合は特に、1枚あたりのファイル容量を小さく（目安: 500KB前後）圧縮しておくことが重要です。画像を多く追加した後は、[Site usageで容量・Bandwidthを確認する](/05-settings/11-site-usage-bandwidth/)も確認してください。
