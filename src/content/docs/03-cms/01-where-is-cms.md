...
3.  <strong>CMSアイテムの一覧が表示される:</strong>
    ...
    ![CMS Collectionsの管理画面（左にコレクション一覧）](../../../assets/captures/manual/b-20-official-cms-item-editing.png)
...
CMSの入り口が分かりましたね。それでは早速、新しい記事を追加してみましょう。「[新しい「お知らせ（ブログ記事）」を追加する方法](/03-cms/02-create-new-post/)」に進みます。
