---
title: "C-10. 本文を箇条書き（リスト）にする方法"
description: "クライアント向けWebflow更新マニュアル：本文を箇条書き（リスト）にする方法"
sidebar:
  order: 9
  label: "C-10. 本文を箇条書き（リスト）にする方法"
---
...
:::note[キャプチャー指示]
撮影する画面: Rich Text本文欄でテキストを選択し、番号なしリストと番号付きリストのアイコンが見えている状態。
保存ファイル名: `c-12-rich-text-list-icons.png`
撮影直前の状態: 本文テキストを選択し、フローティングメニューが表示されている状態。
必ず写すもの: 選択中の本文、番号なしリストアイコン、番号付きリストアイコン、Rich Text欄。
写さないもの: 未公開本文、個人情報、不要な管理画面通知。
:::
