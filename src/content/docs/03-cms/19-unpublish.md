...
3.  **ドロップダウンメニューから「Unpublish」を選択:**
    ...
    ![非公開メニュー](https://uploads-ssl.webflow.com/xxxxxxxx/xxxxxxxx_UnpublishMenu.png)  
    *※画像はイメージです。*
...
**次のステップ:**
記事の公開・非公開を自由にコントロールできるようになりました。次は、記事としてはもう使わないけれど、記録として残しておきたい場合に使う「No.36 不要になった記事を「アーカイブ（保管）」する方法」です。
