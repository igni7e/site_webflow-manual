...
3.  サイト設定画面を開く:
    ...
    CSVダウンロードも、まず対象サイトのForms画面から進みます。
...
:::caution[CSVの扱い]
CSVには氏名、メールアドレス、問い合わせ本文などの個人情報が含まれる場合があります。ダウンロード後は共有先を限定し、不要になったファイルは社内ルールに従って削除してください。
:::
...
![CSVダウンロードの注意の図解](../../../assets/ai-diagrams/manual/forms-csv-privacy.png)
