...
5.  「Export to CSV」ボタンをクリック:
    ...
    ![CSVエクスポートボタン](../../../assets/captures/export-csv.svg)
    *※画像はイメージです。*
...
次のステップ:
お問い合わせフォームの管理はこれで完璧ですね。次は、Webサイト運用でよくある疑問やトラブルの解決策をまとめた「F：よくある質問・トラブル解決」に進みます。まずは「[No.53](/06-troubleshooting/01-cache-not-reflecting/) 「変更を保存したのに、サイトに反映されません！」なぜ？（キャッシュ解説）」です。
