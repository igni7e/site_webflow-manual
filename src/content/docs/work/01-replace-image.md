...
:::note[キャプチャー指示]
撮影する画面: 画像にカーソルを合わせ、画像編集アイコンが出ている状態。
保存ファイル名: `work-02-replace-image-edit-icon.png`
撮影直前の状態: 対象画像と編集アイコンが両方見える状態。
必ず写すもの: 差し替え対象画像、画像編集アイコン、周辺の見出し。
写さないもの: 未公開画像、個人情報、不要な管理画面通知。
:::
